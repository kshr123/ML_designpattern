...
| 05 | **iris_sklearn_outlier** | 外れ値検出（教師なし学習） | ⭐⭐ | ⏸️ 未着手 |
| 06 | **cifar10** | CNN画像分類（深層学習） | ⭐⭐⭐ | ⏸️ 未着手 |

### 進捗状況

- **完了**: 4/6 パターン
- **次の目標**: 05_iris_sklearn_outlier または 06_cifar10
...
│   ├── README.md
│   └── ...
├── 05_iris_sklearn_outlier/     # ⏸️ 外れ値検出
│   └── ...
└── 06_cifar10/                  # ⏸️ CNN画像分類
    └── ...
```
